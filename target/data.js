...
var runs = {
   "1":{
      "\\\\dummy\\sub_path\\sub_sub_path\\2.adf":{
         "status":"SUCCESS",
         "fails":[
      ...
      "\\\\dummy\\sub_path\\sub_sub_path\\3.adf":{
         "status":"ERROR",
         "fails":[
         ...
         "errors":[
            {
               ...
               "message":"cannot join using column tooth_id - column not present in both tables",
   ...
   "2":{
      "\\\\dummy\\sub_path\\sub_sub_path\\4.adf":{
         "status":"SUCCESS",
         "fails":[
      ...
      "\\\\dummy\\sub_path\\sub_sub_path\\5.adf":{
         "status":"SUCCESS",
         "fails":[
   ...
   "3":{
      "\\\\dummy\\sub_path\\sub_sub_path\\6.adf":{
         "status":"UNDEFINED",
         "fails":[
      ...
      "\\\\dummy\\sub_path\\sub_sub_path\\7.adf":{
         "status":"FAIL",
         "fails":[
            {
               "meta":[
               ...
               "type":"AssertError.SpacingLeaveSpecificError.FixedSpaceError",
               "message":"Space mentioned in prescription is not set to Fixed in FiPos,                 or values don't match. Problem tooth: 9"
            }
         ],
         "errors":[
   ...
   "4":{
      "\\\\dummy\\sub_path\\sub_sub_path\\8.adf":{
         "status":"UNDEFINED",
         "fails":[
...
var quarantine = {
	"1" : {
		"\\\\dummy\\sub_path\\sub_sub_path\\2.adf" : "SUCCESS"
	},
	"2" : {
		"\\\\dummy\\sub_path\\sub_sub_path\\4.adf" : "SUCCESS"
	},
	"3" : {
		"\\\\dummy\\sub_path\\sub_sub_path\\6.adf" : "UNDEFINED"
	}
}
